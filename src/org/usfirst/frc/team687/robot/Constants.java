...
//	public static double kDistF = 0; // You probably want to put value calcs here rather than the number
//	public static double kDistP = 0;
//	public static double kDistI = 0;
//	public static double kDistD = 0;
//	
//	public static double kRotP = 0;
//	public static double kRotI = 0;
//	public static double kRotD = 0;
//	public static double kMinRotPower = 0;
//	public static double kMaxRotPower = 1.0;
